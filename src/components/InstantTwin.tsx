...
export default function InstantTwin() {
  ...
  return (
    <div className="beam relative mx-auto w-full max-w-[420px] overflow-hidden rounded-3xl border border-line bg-surface shadow-[0_2px_8px_rgba(10,37,64,.05),0_24px_60px_rgba(10,37,64,.1)]">
